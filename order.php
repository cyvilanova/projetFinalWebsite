      ...
      <div class="modal-content">
        ...
        <div class="modal-body left">
         ...
         <div class="form-group">
              ...
              <select id="product-order-edit" name="products" class="selectpicker form-control">
...
<div class="modal fade" id="modal-edit-orders" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body left">
          <form>
           <div class="form-group">
              <label for="client" class="col-form-label">Client </label>
              <input type="text" name="client" class="form-control" placeholder="Roger Lapierre" required id="client-name-edit">  
            </div>

          <div class="form-group">
              <label for="address" class="col-form-label">Adresse </label>
              <input type="text" name="address" class="form-control" placeholder="123 Rue de l'oranger" required id="client-address-edit">  
            </div>
          ...
          <div class="form-group">
              <label for="province" class="col-form-label">Province </label>
              <select name="province" class="selectpicker form-control" id="client-province-edit">
                <option value="Alberta">Alberta</option>
                <option value="Colombie-Britannique">Colombie-Britannique</option>
                <option value="Île-du-Prince-Édouard">Île-du-Prince-Édouard</option>
                <option value="Manitoba">Manitoba</option>
          ...
          <div class="form-group">
              <label for="products" class="col-form-label">Produits </label>
              <select id="product-order-edit" name="products" class="selectpicker form-control" onchange="addProduct(this)">
                <option disabled selected value>Choisir un ou plusieurs produits</option>
              <?php
                $ctrlP = new CtrlProduct();
                $ctrlP->loadAllProductsSelect();
            ...
            <div class="form-group" id="order-products-edit">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-light" data-dismiss="modal">Fermer</button>
          <button type="button" class="btn btn-default" data-dismiss="modal" id="btn-delete-modal">Supprimer</button>
          <input type="submit" class="btn btn-default" id="btn-edit-modal" value="Sauvegarder"/>
          </form>
        </div>
      </div>
  </div>
